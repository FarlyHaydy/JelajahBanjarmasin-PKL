                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 text-center">
                            <div class="no-data-message">
                                <i class="fas fa-map-signs fa-4x mb-4" style="color: rgba(255,255,255,0.3);"></i>
                                <h3 style="color: #fff; margin-bottom: 20px;">Belum Ada Destinasi Rekreasi</h3>
                                <p style="color: rgba(255,255,255,0.7); font-size: 1.1rem;">
                                    Destinasi rekreasi akan muncul di sini setelah admin menambahkannya.
                                </p>
                            </div>
                        </div>
                    </div>
